...
<div class="container">
  <div class="jumbotron">
    <h1>Public Dashboard</h1>     
        ...
        <a class="btn btn-primary btn-lg btn-block" href="addAthletes.php" style="background-color: #cc0000;">Reserve Tickets</button>
        <a class="btn btn-primary btn-lg btn-block" href="modifySchedule.php" style="background-color: #cc0000;">Schedule Autograph Session</button>
        <a class="btn btn-primary btn-lg btn-block" href="modifySchedule.php" style="background-color: #cc0000;">View Schedule</button>
    <!-- </div>
</div> -->
