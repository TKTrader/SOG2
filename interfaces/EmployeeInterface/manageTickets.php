...
if ($_SERVER['REQUEST_METHOD']=='POST') {
  if (isset($_POST['confirmTicketBtn'])) { 
  ...
  <body>
              ...
              if ($result = $mysqli->query($query)) {
                  while ($row = $result->fetch_assoc()) {
                      ...
                      echo '<tr value='.$value.'> 
                              ...
                              <td class="text-center"><button type=\'button\' class=\'btn\' data-toggle="modal" data-target="#purchaseModal" value='.$value.' onClick="setCurrentTicket(this)">Request Ticket</button></td>
                          </tr>';
                      $value++;
                  }
      ...
      <script>
          ...
          function setCurrentTicket(element){
              ...
              document.getElementById('confirmTicketPurchaseBtn').innerHTML = "Confirm Order of Ticket";
                      ...
                      <div class="container">
                          <div class="row">
                              <div class="col-md-12 order-md-1">
                                  ...
                                  <form class="needs-validation" action="manageTickets.php" method="post" novalidate>
                                      <div class="row">
                                      ...
                                      <hr class="mb-4">
                                      <button id="confirmTicketPurchaseBtn" class="btn btn-primary btn-lg btn-block" name="confirmTicketBtn"></button>
                                  </form>
                              </div>
                          </div>
                      </div>
